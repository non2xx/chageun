...
바이브 코딩의 흔한 구멍 — **키 노출·접근제어 꺼짐·인증 누락·입력 검증 없음·취약한 의존성** — 을 **무료 스캔으로 자동 점검**한다. honclwd는 스캔 인프라를 품지 않는다(A안) — 발동될 때 그 프로젝트에 스캔 설정을 **생성·안내**할 뿐이다.
